...
" Normal mode
let s:N1 = [ '#bfbfbf' , '#1C1C1C' , 232 , 144 ] " mode
if get(g:, 'airline_molokai_bright', 0)
  let s:N2 = [ '#bfbfbf' , '#1C1C1C' , 253 , 208 ] " info
else
  let s:N2 = [ '#bfbfbf' , '#1C1C1C' , 253 , 16 ] " info
endif
let s:N3 = [ '#bfbfbf' , '#1C1C1C' , 253 , 67  ] " statusline
...
let g:airline#themes#molokai#palette.normal_modified = {
      \ 'airline_c': [ '#bfbfbf' , '#1C1C1C' , 232 , 144 , '' ] ,
      \ }

" Insert mode
let s:I1 = [ '#bfbfbf' , '#1C1C1C' , 232 , 81  ]
if get(g:, 'airline_molokai_bright', 0)
  let s:I2 = [ '#bfbfbf' , '#1C1C1C' , 253 , 208 ]
else
  let s:I2 = [ '#bfbfbf' , '#1C1C1C' , 253 , 16 ]
endif
let s:I3 = [ '#bfbfbf' , '#1C1C1C' , 253 , 67  ]
...
let g:airline#themes#molokai#palette.insert_modified = {
      \ 'airline_c': [ '#bfbfbf' , '#1C1C1C' , 232 , 81 , '' ] ,
      \ }

" Replace mode
let s:R1 = [ '#bfbfbf' , '#1C1C1C' , 232 , 161 ]
if get(g:, 'airline_molokai_bright', 0)
  let s:R2 = [ '#bfbfbf' , '#1C1C1C' , 253 , 208 ]
else
  let s:R2 = [ '#bfbfbf' , '#1C1C1C' , 253 , 16 ]
endif
let s:R3 = [ '#bfbfbf' , '#1C1C1C' , 253 , 67  ]
...
let g:airline#themes#molokai#palette.replace_modified = {
      \ 'airline_c': [ '#bfbfbf' , '#1C1C1C' , 232 , 161 , '' ] ,
      \ }

" Visual mode
let s:V1 = [ '#bfbfbf' , '#1C1C1C' , 232 , 118 ]
if get(g:, 'airline_molokai_bright', 0)
  let s:V2 = [ '#bfbfbf' , '#1C1C1C' , 253 , 208 ]
else
  let s:V2 = [ '#bfbfbf' , '#1C1C1C' , 253 , 16 ]
endif
let s:V3 = [ '#bfbfbf' , '#1C1C1C' , 253 , 67  ]
...
let g:airline#themes#molokai#palette.visual_modified = {
      \ 'airline_c': [ '#bfbfbf' , '#1C1C1C' , 232 , 118 , '' ] ,
      \ }

" Inactive
let s:IA = [ '#bfbfbf' , '#1C1C1C' , 233 , 67 , '' ]
...
let g:airline#themes#molokai#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
      \ [ '#f8f8f0' , '#1C1C1C' , 253 , 67  , ''     ] ,
      \ [ '#f8f8f0' , '#1C1C1C' , 253 , 16  , ''     ] ,
      \ [ '#080808' , '#1C1C1C' , 232 , 144 , '' ] )
